...
namespace Native.Csharp.App.Export
{
	...
	{	
		...
		{	
			...
			type.GetProperty ("Id", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "xyz.hbyzhonoka.honobot" });	
			...
			type.GetProperty ("Name", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "Honobot" });	
			...
			type.GetProperty ("Description", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "果果机器人" });	
		...
		{	
			return "9,xyz.hbyzhonoka.honobot";	
		}	
		...
		{	
			...
			Common.AppInfo.UnityContainer.RegisterInstance<CQApi> ("xyz.hbyzhonoka.honobot", api);	
			// 向容器注册一个 CQLog 实例	
			log = new CQLog (authCode);	
			Common.AppInfo.UnityContainer.RegisterInstance<CQLog> ("xyz.hbyzhonoka.honobot", log);	
